	...
	*/ 
	...
	this.endpointParamSpec = function (path)
	{
		...
		specs['/mvva/pay/AVS']   = FlutterwaveBase.objectBuilder({})
						     ...
						     .build('cardname', 'required:true, encrypt:true')
						     ...
						     .build('cardemail', 'required:true, encrypt:true')
						     .build('cardzip', 'required:true, encrypt:true')
						     .build('cardphonenumber', 'required:true, encrypt:true')
						     .build('cardphonetype', 'required:true, encrypt:true')
						     .end(); 
